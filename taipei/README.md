...
- `Taipei Changchun Ambassador Cinema`, `Xinzhuang Ambassador Cinema`, `Tamsui Ambassador Cinema`, `Bade Ambassador Cinema`, `Taipei Ximen in89 Cinema`, and `Taoyuan Station in89 Cinema` are included under the broader hybrid-cinema rule: they are larger commercial venues, but their programming mix regularly overlaps with restorations, festival titles, repertory, and other non-mainstream releases.
